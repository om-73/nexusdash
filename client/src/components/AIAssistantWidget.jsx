...
export default function AIAssistantWidget() {
    ...
    const [messages, setMessages] = useState([
        {
            role: 'assistant',
            content: 'Hello! I am **Nexus AI**, your data intelligence assistant. I am powered by **Gemini 2.0 Flash** ⚡\n\nHow can I help you with your data workflow, cleaning, or machine learning model today?'
        }
    ]);
                    ...
                    <div className="flex items-center justify-between p-4 bg-slate-900/60 border-b border-slate-800/80">
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-indigo-400 font-semibold uppercase tracking-wider">Gemini 2.0 Flash</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-2">
                            <button
