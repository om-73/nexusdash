        ...
        <>
            ...
            <div className={clsx(
                ...
                <nav className="flex-1 space-y-1">
                    ...
                    <SidebarItem to="/features" icon={Zap} label="Feature Engineering" onClick={onClose} />
                    ...
                    <SidebarItem to="/predict" icon={BarChart2} label="Use Model (Predict)" onClick={onClose} />
                </nav>
    ...
    return (
        <div className="min-h-screen bg-white text-slate-900">
            ...
            <div className="md:ml-64 min-h-screen pt-16 md:pt-0 transition-all duration-300">
                <Suspense fallback={
                    <div className="flex h-[calc(100vh-4rem)] md:h-screen w-full items-center justify-center p-12 text-slate-500">
