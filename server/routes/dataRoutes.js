...
router.post('/kpi/calculate', dataController.calculateKPI);
router.get('/model/download', dataController.downloadModel);
router.get('/model/metadata', dataController.getModelMetadata);
router.post('/predict', dataController.predictModel);
...
router.post('/feature/engineer', auditLogger('Feature Engineering'), dataController.engineerFeature);
